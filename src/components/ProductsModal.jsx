...
export default function ProductsModal({ open, onClose, dealId, dealTitle, dealCurrency, onSaved }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <div className="absolute inset-0 bg-black/60 overlay-in" />
      <div ref={containerRef} className="relative w-full max-w-4xl max-h-[90vh] bg-brand-panel border border-brand-border rounded-2xl shadow-2xl flex flex-col overflow-hidden modal-in">
        {/* Header */}
